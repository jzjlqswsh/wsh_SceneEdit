package awaybuilder.model
{
	...
	public class SmartFactoryModelBase
	{
		...
		protected function createAsset( item:Object ):AssetVO
		{
			...
			switch(true)
			{
				case(item is ExpandMesh):
					return fillExpandMesh( new ExpandMeshVO(), item as ExpandMesh );
				case(item is Mesh):
...
//					asset.dedicatedMesh = outlineMethod.dedicatedMesh;
		...
		private function fillExpandMesh( asset:ExpandMeshVO, item:ExpandMesh ):ExpandMeshVO
		{
			asset = fillObject( asset, item ) as ExpandMeshVO;
			asset.path = item.myPath;
			return asset;
		}
