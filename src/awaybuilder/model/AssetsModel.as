...
//					method.name =  "ProjectiveTexture " + AssetUtil.GetNextId("ProjectiveTexture");
		...
		//=======创建expandMesh
		public function CreateExpandMesh(path:String):ExpandMeshVO
		{
			//加载expandMesh
			var obj:ExpandMesh = MyMeshData.getExpandMesh(path);
			//var obj:ObjectContainer3D = new ObjectContainer3D();
			//obj.name = "ExpandMesh" + AssetUtil.GetNextId("ExpandMesh");
			return GetAsset( obj ) as ExpandMeshVO;
		}
