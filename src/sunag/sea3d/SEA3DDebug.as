package sunag.sea3d
{
	...
	public class SEA3DDebug extends SEA3D
	{
		...
		override protected function setLookAtObject(sea:SEAObject3D, object3d:Entity):void
		{			
			super.setLookAtObject(sea, object3d);
			_debug.creatLookAt(object3d, _objects[sea.lookAt.index].tag);
		}
