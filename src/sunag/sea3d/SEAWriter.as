package sunag.sea3d
{
	...
	public class SEAWriter extends EventDispatcher
	{
		...
		{			
			writeObject(sea.typeInt, sea.write(), sea.name, sea.compressed);		
			return true;
		}
		
		protected function writeObject(typeInt:int, data:ByteArray, name:String="", compressed:Boolean=true):void
		{			
