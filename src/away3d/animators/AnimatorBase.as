package away3d.animators
{
	...
	public class AnimatorBase extends EventDispatcher
	{
		...
		//是否帧动画 即是否存储每帧的数据
		protected var _frameAnimation:Boolean = false; 
		public function get frameAnimation():Boolean 
		{
			return _frameAnimation;
		}
		public function setFrameAnimation(value:Boolean):void 
		{
		...
		//起始帧偏移
		protected var _beginFrame:int = 0;
		/**
		...
		public function start() : void
		{
			...
			_time = _absoluteTime = _startTime = getTimer();
			if (!_autoUpdate) {
				_isPlaying = true;
				update(_time);
			}
